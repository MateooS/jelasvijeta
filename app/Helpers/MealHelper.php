...
if (!function_exists('checkDiffTime')) {
  function getDiffTime(Request $request) {
...
if (!function_exists('getCatStatus')) {
  function getCatStatus(Request $request) {
    if ($request['category']) {
...
if (!function_exists('createResponse')) {
  function createResponse(Request $request, LengthAwarePaginator $meals) {
    $response = array();
...
if (!function_exists('getStatus')) {
  function getStatus(Request $request, Model $meal) {
    if (isset($request['diff_time'])) {
...
if (!function_exists('translateBase')) {
  function translateBase(Request $request, array $response, Model $meal,
  string $status, int $i) {
...
if (!function_exists('getCatArray')) {
  function getCatArray(Request $request, array $response, Model $meal, int $i) {
...
if (!function_exists('getTagsArray')) {
  function getTagsArray(Request $request, array $response, Model $meal, int $i) {
    /* Prepare arrays */
...
if (!function_exists('getIngredientsArray')) {
  function getIngredientsArray(Request $request, array $response, Model $meal,
  int $i) {
